...
function Register({ onToggleForm }) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 rounded-xl backdrop-blur-lg bg-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] border border-white/20">
      <h2 className="text-2xl font-medium text-center text-[#1A1A1F] mb-6">
        Join <span className="text-[#FD366E] font-semibold">BeginnerContribute</span>
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="group">
          <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2 transition-all group-focus-within:text-[#FD366E]">
            Name
          </label>
